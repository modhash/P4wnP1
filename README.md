...
This repo isn't really suspended, but I'm using all of my time to work on P4wnP1's successor P4wnP1_aloa. 
The information on progress are published via twitter, from time to time ([@P4wnP1](https://twitter.com/p4wnp1) or [@MaMe82](https://twitter.com/mame82)).
